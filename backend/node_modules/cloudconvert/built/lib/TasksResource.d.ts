import CloudConvert, { type UploadFileSource } from './CloudConvert';
...
export default class TasksResource {
    ...
    upload(task: Task | JobTask, stream: UploadFileSource, filename?: string, fileSize?: number): Promise<any>;
